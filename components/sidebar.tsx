...
export function Sidebar() {
  ...
  const navItems = [
    {
      name: labels.sidebar.dashboard,
      href: "/",
      icon: LayoutDashboard,
      roles: ["admin", "sale_admin", "market_staff"],
    },
    {
      name: labels.sidebar.contracts,
      href: "/contracts",
      icon: FileText,
      roles: ["admin", "sale_admin"],
    },
    {
      name: labels.sidebar.templates,
      href: "/templates",
      icon: Settings,
      roles: ["admin", "sale_admin"],
    },
    {
      name: labels.sidebar.marketVisits,
      href: "/market-visits",
      icon: MapPin,
      roles: ["admin", "sale_admin", "market_staff"],
    },
    {
      name: labels.sidebar.customers,
      href: "/customers",
      icon: Building2,
      roles: ["admin", "sale_admin", "market_staff"],
    },
    {
      name: labels.sidebar.products,
      href: "/products",
      icon: Package,
      roles: ["admin", "sale_admin"],
    },
    {
      name: labels.sidebar.reports,
      href: "/reports",
      icon: BarChart3,
      roles: ["admin", "sale_admin"],
    },
    {
      name: labels.sidebar.admin,
      href: "/admin",
      icon: Shield,
      roles: ["admin"],
    },
  ...
  const roleName = labels.roles[profile.role] || profile.role
